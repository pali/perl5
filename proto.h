...
STATIC Size_t	S_do_trans_complex(pTHX_ SV * const sv, OPtrans_map * tbl)
			__attribute__warn_unused_result__;
#define PERL_ARGS_ASSERT_DO_TRANS_COMPLEX	\
	assert(sv); assert(tbl)

STATIC Size_t	S_do_trans_count(pTHX_ SV * const sv, OPtrans_map * tbl)
			__attribute__warn_unused_result__;
#define PERL_ARGS_ASSERT_DO_TRANS_COUNT	\
	assert(sv); assert(tbl)

STATIC Size_t	S_do_trans_count_utf8(pTHX_ SV * const sv, AV * const map)
			__attribute__warn_unused_result__;
#define PERL_ARGS_ASSERT_DO_TRANS_COUNT_UTF8	\
	assert(sv); assert(map)

STATIC Size_t	S_do_trans_simple(pTHX_ SV * const sv, OPtrans_map * tbl)
			__attribute__warn_unused_result__;
#define PERL_ARGS_ASSERT_DO_TRANS_SIMPLE	\
	assert(sv); assert(tbl)

STATIC Size_t	S_do_trans_utf8(pTHX_ SV * const sv, AV * const map)
			__attribute__warn_unused_result__;
#define PERL_ARGS_ASSERT_DO_TRANS_UTF8	\
	assert(sv); assert(map)
